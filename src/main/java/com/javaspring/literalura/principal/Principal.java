package com.javaspring.literalura.principal;

import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
import com.javaspring.literalura.models.*;
import com.javaspring.literalura.repository.AutorRepository;
import com.javaspring.literalura.repository.LibroRepository;
import com.javaspring.literalura.services.ConsumeAPI;
import com.javaspring.literalura.services.ConvierteDatos;
...
//    private Optional<Autor> autor;
        ...
        while (opcion != 0) {
            String menu = """
                    ...
                    ******************  Menú Principal  ************************
                        ...
                        4 - Mostrar Autores que vivieron en un determinado año
            ...
            switch (opcion) {
                ...
                default:
                    System.out.println("Opción de Menú no valida!!!  Intenta de nuevo por favor: ");
    ...
    private void librosPorIdioma() {
        System.out.println("Indica las siglas del idioma que deseas buscar: ");
        String menuIdiomas = """
        ...
        if (!idioma.equals("es") && !idioma.equals("en") && !idioma.equals("fr") && !idioma.equals("pt")) {
            System.out.println("Idioma no válido, Intenta de nuevo. Por favor: ");
            return;
        }
    ...
    private void autoresPorYear() {
        System.out.println("Proporciona el año en el que deseas buscar al/los Autor(es). Por favor: ");
    ...
    private void buscarLibro() {
        System.out.println("Proporciona el Título del Libro que deseas buscar: ");
